...
# -*- coding: utf-8 -*-
#
# binst documentation build configuration file, created by
# sphinx-quickstart on Tue May 31 23:08:19 2016.
#
...
latex_documents = [
  (master_doc, 'binst.tex', 'binst Documentation',
   'Chapman Siu', 'manual'),
]
...
man_pages = [
    (master_doc, 'binst', 'binst Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'binst', 'binst Documentation',
   author, 'binst', 'One line description of project.',
   'Miscellaneous'),
]
